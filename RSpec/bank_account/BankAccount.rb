# Develop a test suite using RSpec for a Ruby class BankAccount with methods to deposit, withdraw, and check_balance. Ensure that withdrawing more than the available balance raises an appropriate error.
